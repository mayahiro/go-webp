...
| --- | --- | ---: | ---: |
| Lossy Q75 | UI 256x256 | 17.581 ms | 2,906 bytes |
| Lossy Q75 | Photo-like 512x512 | 115.379 ms | 142,078 bytes |
| Lossless | Gradient 128x128 | 33.042 ms | 58 bytes |
| Lossless | Photo-like 512x512 | 811.380 ms | 23,770 bytes |
